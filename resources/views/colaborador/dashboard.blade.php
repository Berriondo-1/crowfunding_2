                ...
                @foreach ($proyectosExplorar as $proyecto)
                    ...
                    <article class="rounded-3xl border border-white/10 bg-zinc-950/75 p-4 shadow-[0_12px_45px_rgba(0,0,0,0.35)] ring-1 ring-indigo-500/10 flex flex-col gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            @endphp
                            <div class="flex items-center gap-2 text-[12px] text-amber-300">
                                <div class="flex items-center gap-0.5">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 {{ $i <= $filled ? 'fill-current' : 'text-zinc-600' }}" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                    @endfor
                                </div>
                                <span class="text-zinc-200 font-semibold">{{ $avgRating }} / 5</span>
                                <span class="text-zinc-500">({{ $ratingTotal }})</span>
                            </div>
                        </div>
