...
<body class="bg-zinc-950 text-zinc-100 font-sans min-h-screen">
    ...
    <header class="sticky top-0 z-30 border-b border-white/10 bg-zinc-950/80 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-lg font-semibold text-white">Módulo de proyectos</h1>
            </div>
    ...
    <main class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section class="rounded-3xl border border-white/10 bg-zinc-900/70 p-8 shadow-2xl">
            ...
            <h2 class="mt-2 text-2xl font-bold text-white">Supervisión de proyectos</h2>
            <p class="mt-2 text-sm text-zinc-400">
                Aquí centralizaremos publicación, validación y estado de campañas (HU4-HU7). Próximamente métricas, filtros y flujos de aprobación.
            </p>
            <div class="mt-6 rounded-2xl border border-dashed border-white/15 bg-white/5 p-6 text-sm text-zinc-300">
                Próximamente: tablero de proyectos con filtros por estado, verificaciones y hitos financieros.
            </div>
        </section>
    </main>
</body>
